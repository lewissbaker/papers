...
#+TITLE: D3425R1: Reducing operation-state sizes for subobject child operations
#+AUTHOR: Lewis Baker
...
<ins>  template&lt;class Op, class Rcvr&gt;
  ...
  struct <expos>basic-operation</expos><del> : <expos>basic-state</expos>&lt;Sndr, Rcvr&gt; {</del>                <expos>// exposition only</expos>
    <ins>: <expos>inlinable-operation-state</expos>&lt;<expos>basic-operation</expos>&lt;Sndr, Rcvr&gt;, Rcvr&gt;
    , State
  ...
  struct <expos>basic-sender</expos> : <expos>product-type</expos>&lt;Tag, Data, Child...&gt; {    <expos>// exposition only</expos>
    ...
    auto connect(this Self&amp;&amp; self, Rcvr rcvr) noexcept(<i>see below</i>)
      -&gt; <expos>basic-operation</expos>&lt;Self, Rcvr&gt; {
...
<div class="wording">
<pre>template<>
struct <expos><ins>state-</ins>impls-for</expos>&lt;<expos>decayed-typeof</expos>&lt;<expos>just-cpo</expos>&gt;&gt; : <expos>default-impls</expos> {
...
<div class="wording">
<pre>template<>
struct <expos><ins>state-</ins>impls-for</expos>&lt;<expos>decayed-typeof</expos>&lt;read_env&gt;&gt; : <expos>default-impls</expos> {
...
<div class="wording">
<pre>template<>
struct <expos><ins>state-</ins>impls-for</expos>&lt;<expos>decayed-typeof</expos>&lt;<expos>then-cpo</expos>&gt;&gt; : <expos>default-impls</expos> {
...
<div class="wording">
<pre>template<>
struct <expos><ins>state-</ins>impls-for</expos>&lt;bulk_t&gt; : <expos>default-impls</expos> {
...
** Changes to /~into_variant~/

Forthcoming.

** TODO Changes to /~into_variant~/ :noexport:
...
<div class="wording">
<pre>template<>
struct <ins>sender-</ins>impls-for&lt;into_variant_t&gt; : default-<ins>sender-</ins>impls {
  <del>static constexpr auto get-state = see below ;
  static constexpr auto complete = see below ;</del>
  <ins>template&lt;class Self&gt;
  default-state&lt;tag_of_t, decay_t&lt;data-type-t&lt;Self&gt;&gt;&gt;
    get-state(this Self&& self) // exposition only
      noexcept(is-nothrow-decay-copyable-v&lt;data-type-t&lt;Self&gt;&gt;);</ins>
};</pre>
</div>
#+END_EXPORT

** Changes to /~run_loop::run-loop-sender~/
